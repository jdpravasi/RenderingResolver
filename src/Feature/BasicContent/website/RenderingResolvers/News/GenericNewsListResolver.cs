...
{
    public class GenericNewsListResolver : RenderingContentsResolver
    {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            var category = rendering.Parameters["Category"];

            var childrenItems = ds.GetChildren().Where(i => i.TemplateID == Templates.News.content.TemplateID && i.Fields[Templates.News.content.Category].Value == category).ToList();
