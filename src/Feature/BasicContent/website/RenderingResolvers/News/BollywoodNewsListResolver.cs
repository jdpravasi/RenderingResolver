...
{
    public class BollywoodNewsListResolver : RenderingContentsResolver
    {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            var childrenItems = ds.GetChildren().Where(i => i.TemplateID == Templates.News.content.TemplateID && i.Fields[Templates.News.content.Category].Value == "Bollywood").ToList();
